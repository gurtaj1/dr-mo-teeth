            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <AnimatedElement>
                  ...
                  <ul className=" space-y-3">
                    ...
                    <li>
                      ...
                      Dont&apos;s in preparation for the sedation and give you
                      and your escort written information
                    </li>
                  </ul>
                </AnimatedElement>
              </div>
              <div className="bg-white/10 p-6 rounded-lg">
                <AnimatedElement>
                  ...
                  <ul className=" space-y-3">
                    <li>
                      • The dentist will explain the planned treatment and
              ...
              <div className="bg-white/10 p-6 rounded-lg">
                <AnimatedElement>
                  ...
                  <ul className=" space-y-3">
                    <li>
                      • You&apos;ll be taken to a recovery area where your
                      escort will wait
                    </li>
                    <li>• Most people spend about 30 minutes in recovery</li>
                    <li>
                      • The cannula stays in place until you&apos;re fit to
                      leave
                    </li>
                    <li>
                      • Once ready, you will be accompanied by your escort,
                      driven home and looked after
                    </li>
                    <li>
                      • Expect to feel sleepy and a bit clumsy; you won&apos;t
                      be able to leave until checked by the dentist
                    </li>
                  </ul>
                </AnimatedElement>
              </div>
