      ...
      <div className="min-h-screen bg-white overflow-x-hidden">
        ...
        >
          <ul className="space-y-2">
            ...
            <li>
              ✓ A risk assessment of your mouth for tooth wear, decay, gum
              disease
            </li>
        ...
        >
          <div className="space-y-6 ">
            <p>
              ...
              your teeth and gums healthy. During this treatment, your dentist
              or hygienist will remove plaque and tartar build up from your
              teeth using special tools. This helps prevent gum disease and
              cavities.
            </p>
            <p>
              After scaling, they will polish your teeth with a gritty
              toothpaste to remove stains and leave them feeling smooth and
              clean. A scale and polish is an important part of your regular
              dental care routine and can help you maintain a bright smile and
              fresh breath!
            </p>
          </div>
        </AnimatedImageTextSection>
