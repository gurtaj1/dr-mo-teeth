      ...
      <div className="min-h-screen bg-white overflow-x-hidden">
        ...
        >
          <div className="space-y-6">
            <p>
              A radiant, confident smile is one of the first things people
              notice. If you&apos;re unhappy with the appearance of your teeth,
              a Smile Makeover can provide the transformation you&apos;ve been
              dreaming of. Whether you&apos;re dealing with crooked, stained,
              chipped, or missing teeth, we offer customised solutions to help
              you achieve the beautiful smile you deserve. What is a Smile
              Makeover? A Smile Makeover is a comprehensive approach to
              improving the aesthetics of your smile. It combines various
              cosmetic dental treatments, tailored to your unique needs and
              goals. From teeth whitening to veneers, dental crowns, and
              orthodontics, a Smile Makeover can address a wide range of dental
              concerns, giving you a refreshed and youthful appearance.
            </p>
          </div>
        </AnimatedImageTextSection>
        ...
        >
          <div className="space-y-6">
            <p>
              Depending on your needs, a Smile Makeover may include one or more
            ...
            <ol className="space-y-4">
              <li>
                ...
                <p>
                  ...
                  examine your teeth and gums, and determine which treatments
                  are right for you.
                </p>
              </li>
              <li>
                ...
                <p>
                  ...
                  results. This may involve a combination of services, and we
                  will ensure that each procedure is designed to complement your
                  overall goals.
                </p>
              </li>
              <li>
              ...
              <li>
                ...
                <p>
                  ...
                  Regular check-ups will help maintain the beauty and function
                  of your smile.
                </p>
              </li>
            </ol>
