      ...
      <section className="flex-grow py-16 bg-dental-navy">
        <AnimatedElement>
          ...
          >
            ...
            <p className="mt-4">
              You wear each set of aligners for about one to two weeks, and then
              switch to the next set in the series. The best part is that you
              can easily remove them for eating, brushing, and flossing, which
